...
public class FRInfoboxExtractor extends Extractor {
	public FRInfoboxExtractor() {
		super();
	}

	public FRInfoboxExtractor(String xmlName, String outputFile) {
		super();
		setParser(xmlName);
